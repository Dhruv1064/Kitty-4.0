...
void loop()
{
      ...
      if ( counter2_2 != temp2_2 ){
        ...
        correction1_1 = map(abs(c1_1), 0, 70, 0, 70);       
...
//        Serial.println("------------------------");
        ...
        error1_2 = theta1_2 - theta1c_2 + 54.303;         
        error2_2 = theta2_2 - theta2c_2/4 + 54.53;
        ...
        Serial.println(theta1c_2-54.303);
        Serial.print("theta2c_2=");
        Serial.println(theta2c_2-54.53);        
...
//        Serial.println("------------------------");
        ...
        correction1_2 = map(abs(c1_2), 0, 70, 0, 70 );
